...
AppName=ChachaweeSystem
AppVerName=ChachaweeSystem V1
...
DefaultDirName={pf}\ChachaweeSystem
DefaultGroupName=ChachaweeSystem
InfoBeforeFile=..\WriteUps\RestoSis.txt
OutputDir=..\SetupOutput
OutputBaseFilename=ChachaweeSystemSetup
Compression=lzma
...
Source: ..\Build\RestoSys.exe.config; DestDir: {app}; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: {group}\chachaweeSystem; Filename: {app}\RestoSys.exe; WorkingDir: {app}; IconIndex: 0
Name: {commondesktop}\chachaweeSystem; Filename: {app}\RestoSys.exe; Tasks: desktopicon; WorkingDir: {app}; IconIndex: 0

[Run]
Filename: {app}\RestoSys.exe; Description: {cm:LaunchProgram,chachaweeSystem}; Flags: nowait postinstall skipifsilent
