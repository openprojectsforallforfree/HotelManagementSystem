...
namespace Pasal.Reports
{
    ...
    static class StaticInvoice
    {
        ...
        //Bill Details
        private static string BillNo = "123123123";
        private static string Date = "12/55/2011";
        private static DataTable Particulars;
        private static string GrossTotal = "9999999";
        private static string NetTotal = "9999999";
        private static string Discount = "55555";
        private static string Tender = "9999999";
        private static string ReturnAmt = "9999999";

        private static Font printFont = new Font("Lucida Console", 7);
        private static Pen blackPenDash = new Pen(Color.Black, 1);
        static StaticInvoice()
        {
            blackPenDash.DashStyle = System.Drawing.Drawing2D.DashStyle.Dash;
            printDoc.PrintPage += new PrintPageEventHandler(printDoc_PrintPage);
        }

        public static void Print(string billNo, string date, string net, string gross, string discount, string tender,string returnAmt, DataTable particulars)
        {
            BillNo = billNo;
            Date = date;
        ...
        public static void prntit(Graphics g)
        {
            //Define Constants
        ...
        static int rateWidth;
        static int qtyWidth;
        static int amtWidth;
        private static void printTable(Graphics g)
        {
            snWidth = 3;
            descWidth = 9;
            rateWidth = 5;
        ...
        public static string getParticulars(string sno, string particular, string rate, string quantity, string amount)
        {
    ...
    static class StringFormater
    {
        ...
        public static string get2DigitsMust(string inStr)
        {
            if (!inStr.Contains("."))
            {
                inStr = inStr + ".00";
