...
namespace UEMS.BLL
{
    ...
    public class Loader
    {
        ...
        public Loader()
        {
            ...
            GlobalValues.dbEngine = Pasal.Properties.Settings.Default.dbEngine;
            GlobalValues.dbName = Pasal.Properties.Settings.Default.dbname;
            GlobalResources.ConnectionString = Pasal.Properties.Settings.Default.Configstring;
        ...
        public void LoadNecessaryObjects()
        {
            ...
            if (Commands.updateDb)
            {
                ...
                (new DMLUserRightsSimple()).UpdateStructure((new Pasal.MainForm()).mnuStripMy);
